...
import static net.ranzer.powergrid.PowerGrid.MODID;
...
//	public static final RegistryObject<PowerMeter> POWERMETER = BLOCKS.register("powermeter", PowerMeter::new);
//	public static final RegistryObject<Item> POWERMETER_ITEM = ITEMS.register("powermeter", () -> new BlockItem(POWERMETER.get(), new Item.Properties().group(ModSetup.ITEM_GROUP)));
